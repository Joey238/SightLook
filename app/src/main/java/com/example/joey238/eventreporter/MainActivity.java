...
public class MainActivity extends AppCompatActivity {
    //implements EventFragment.OnItemSelectListener{ //CommentFragment.OnItemSelectListener{
    //同一activity,两个fragraments
...
//         */
        ...
        /*
            //before 6/26/2017 in onCreate()

        // Show different fragments based on screen size. 动态创建fragment的方法，
//        if (findViewById(R.id.fragment_container) != null) {
//            Fragment fragment = isTablet() ? new  CommentFragment() : new EventFragment();//动态生成fragments
