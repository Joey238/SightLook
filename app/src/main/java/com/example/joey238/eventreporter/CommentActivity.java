...
import static com.example.joey238.eventreporter.R.drawable.comments;
...
public class CommentActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = getIntent();//得到信息，携带了信息
        final String eventId = intent.getStringExtra("EventID");
        final String commenter = intent.getStringExtra("Commenter");

        listView = (ListView) findViewById(R.id.comment_listview);//retrieve the widgets in the UI.
    ...
    private void getData(final String eventId, final CommentAdapter commentAdapter) {
        database.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                commentAdapter.notifyDataSetChanged(); //对database， listview进行更新
            }
